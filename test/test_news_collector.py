...
#
# from parser import news_collector_RBK
# from parser.news_collector_RBK import (  # noqa: E402
#     MACRO_KEYWORDS,
#     NEWS_DAYS,
#     RBK_RSS_URL,
#     SECTOR_KEYWORDS,
...
#             return feed
#
#         monkeypatch.setattr(news_collector_RBK, "feedparser", SimpleNamespace(parse=fake_parse))
...
#         raise news_collector_RBK.requests.RequestException("boom")
#
#     monkeypatch.setattr(news_collector_RBK.requests, "get", fake_get)
#
...
#         ]
#
#     monkeypatch.setattr(news_collector_RBK, "fetch_rbk_rss", fake_fetch_rbk_rss)
#     TICKER_KEYWORDS["SBER"] = ["Сбер"]
#
...
#         }
#
#     monkeypatch.setattr(news_collector_RBK, "collect_news_for_tickers", fake_collect_news_for_tickers)
#
#     from config import TICKERS
#
